...
function MyTaskWorkflow() {
    ...
    //                     }
    //                 >
    //                     <button disabled className="me-1 table-btn btn-exp-red-light disabled">
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="d-flex">
                    ...
                    >
                        <button className="me-1 table-btn" onClick={taskDoneModalShow}>
                    ...
                    >
                        <button className="me-1 table-btn" onClick={stopModalShow}>
                    ...
                    >
                        <button className="me-1 table-btn" onClick={highAlertModalShow}>
                    ...
                    >
                        <button className="me-1 table-btn" onClick={doerModalShow}>
                            <img src={process.env.PUBLIC_URL + 'assets/images/change.svg'} alt="icon" />
                        </button>
                    </OverlayTrigger>
                </div>
        ...
        <React.Fragment>
            ...
            <div className='card'>
                <div className='card-header d-flex flex-wrap justify-content-between align-items-center'>
                    <h3 className="card-title">Checklist Tasks</h3>
            ...
            >
                ...
                <Modal.Footer>
                    <button className='btn btn-exp-primary'>
                        Confirm
                    </button>
                </Modal.Footer>
            </Modal>
