        ...
        },
        {
            ...
            cell: (row) => (
                <div className="d-flex">
                    ...
                    >
                        <Link to="/my-workflow-task-details" className="me-1 table-btn">
                            <img src={process.env.PUBLIC_URL + 'assets/images/disk.svg'} alt="icon" />
                        </Link>
                    </OverlayTrigger>
                    <OverlayTrigger
                    ...
                    >
                        <button className="me-1 table-btn" onClick={detailsModalShow}>
                            <img src={process.env.PUBLIC_URL + 'assets/images/info.svg'} alt="icon" />
                        </button>
                    </OverlayTrigger>
                    <OverlayTrigger
                    ...
                    >
                        <button className="me-1 table-btn" onClick={deleteModalShow}>
                            <img src={process.env.PUBLIC_URL + 'assets/images/bin.svg'} alt="icon" />
                        </button>
                    </OverlayTrigger>
                </div>
