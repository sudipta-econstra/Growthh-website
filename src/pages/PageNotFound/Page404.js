...
function Page404() {
  ...
  return (
    <div className={`page-404-wrap ${theme}`}>
      {/* <svg width="380px" height="500px" viewBox="0 0 837 1045" version="1.1" >
          <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" >
              <path d="M353,9 L626.664028,170 L626.664028,487 L353,642 L79.3359724,487 L79.3359724,170 L353,9 Z" id="Polygon-1" stroke="#3218df" stroke-width="8" ></path>
              <path d="M78.5,529 L147,569.186414 L147,648.311216 L78.5,687 L10,648.311216 L10,569.186414 L78.5,529 Z" id="Polygon-2" stroke="#ce385e" stroke-width="8" ></path>
              <path d="M773,186 L827,217.538705 L827,279.636651 L773,310 L719,279.636651 L719,217.538705 L773,186 Z" id="Polygon-3" stroke="#6231c7" stroke-width="8" ></path>
              <path d="M639,529 L773,607.846761 L773,763.091627 L639,839 L505,763.091627 L505,607.846761 L639,529 Z" id="Polygon-4" stroke="#d7801d" stroke-width="8" ></path>
              <path d="M281,801 L383,861.025276 L383,979.21169 L281,1037 L179,979.21169 L179,861.025276 L281,801 Z" id="Polygon-5" stroke="#0479d6" stroke-width="8" ></path>
          </g>
      </svg> */}
      <svg version="1.1" className="error-svg"
        viewBox="0 0 800 600">
        <g>
          <defs>
      ...
      <div className="message-box">
        ...
        <div className="action-link-wrap mt-4">
          <button className="btn btn-secondary me-3 my-1">Go Back</button>
          <a href="http://growthh.in/" className="btn btn-success my-1">Go to Home Page</a>
        </div>
